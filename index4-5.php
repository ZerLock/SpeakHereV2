...
<html>
    ...
    <h1>Salon SpeakHere #5 :</h1>
    
    <form class="box" action="index4-5_post.php" method="post">
        <p>
...
$reponse = $bdd->query('SELECT pseudo, message FROM minichat5 ORDER BY ID DESC LIMIT 0, 10');
