...
<html>
    ...
    <h1>Salon SpeakHere #4 :</h1>
    
    <form class="box" action="index4-4_post.php" method="post">
        <p>
...
$reponse = $bdd->query('SELECT pseudo, message FROM minichat4 ORDER BY ID DESC LIMIT 0, 10');
