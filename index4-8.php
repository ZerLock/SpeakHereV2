...
<html>
    ...
    <h1>Salon SpeakHere #8 :</h1>
    
    <form class="box" action="index4-8_post.php" method="post">
        <p>
...
$reponse = $bdd->query('SELECT pseudo, message FROM minichat8 ORDER BY ID DESC LIMIT 0, 10');
