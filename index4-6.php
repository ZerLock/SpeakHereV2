...
<html>
    ...
    <h1>Salon SpeakHere #6 :</h1>
    
    <form class="box" action="index4-6_post.php" method="post">
        <p>
...
$reponse = $bdd->query('SELECT pseudo, message FROM minichat6 ORDER BY ID DESC LIMIT 0, 10');
